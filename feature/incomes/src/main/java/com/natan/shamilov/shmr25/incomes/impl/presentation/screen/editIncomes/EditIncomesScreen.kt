package com.natan.shamilov.shmr25.incomes.impl.presentation.screen.editIncomes
...
@Composable
fun EditIncomesScreen(
    incomeId: String,
    viewModel: EditIncomesViewModel = viewModel(factory = LocalViewModelFactory.current),
    onBackPressed: () -> Unit,
) {
    val uiState by viewModel.uiState.collectAsStateWithLifecycle()

    LaunchedEffect(incomeId) {
        viewModel.initialize(incomeId)
    }
...
@Composable
fun EditIncomesContent(
    paddingValues: PaddingValues,
    viewModel: EditIncomesViewModel,
    onBack: () -> Unit = {},
) {
...
//        CustomButton(
//            onButtonClick = { viewModel.deleteTransaction(onSuccess = { onBack() }) },
